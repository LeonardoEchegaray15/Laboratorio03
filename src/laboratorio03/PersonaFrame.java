...
public class PersonaFrame extends javax.swing.JFrame {
    ...
    public PersonaFrame(ListaPersona padre, Persona personaSelect){
        initComponents();
        this.padre = padre;
        this.personaSelect = personaSelect;
        lblNombre.setText(personaSelect.getNombre());
        lblApellido.setText(personaSelect.getApellido());
        lblDNI.setText(personaSelect.getDNI());
    }
